...
CREATE  VIEW M_INFO
	 AS  SELECT INTER_M_INFO.MEMBER_NO,INTER_M_INFO.MEMBER_NAME,EXTERNAL_M_INFO.EXTER_M_NO,EXTERNAL_M_INFO.EXTER_MEM_NAME,EXTERNAL_M_INFO.INTERLINKED_INFO_NUM
		FROM INTER_M_INFO,EXTERNAL_M_INFO;
...
ALTER TABLE INVITE
	ADD (CONSTRAINT  R_44 FOREIGN KEY (EXTER_M_NO) REFERENCES EXTERNAL_M_INFO(EXTER_M_NO));
...
ALTER TABLE NOTICE
	ADD (CONSTRAINT  R_59 FOREIGN KEY (MEMBER_NO) REFERENCES INTER_M_INFO(MEMBER_NO));

ALTER TABLE NOTICE
	ADD (CONSTRAINT  R_60 FOREIGN KEY (EXTER_M_NO) REFERENCES EXTERNAL_M_INFO(EXTER_M_NO));
...
ALTER TABLE PRJ_INFO
	ADD (CONSTRAINT  R_23 FOREIGN KEY (MEMBER_NO) REFERENCES INTER_M_INFO(MEMBER_NO) ON DELETE SET NULL);

ALTER TABLE PRJ_INFO
	ADD (CONSTRAINT  R_24 FOREIGN KEY (PJT_NO) REFERENCES PROJECT(PJT_NO));

ALTER TABLE PRJ_INFO
	ADD (CONSTRAINT  R_58 FOREIGN KEY (EXTER_M_NO) REFERENCES EXTERNAL_M_INFO(EXTER_M_NO) ON DELETE SET NULL);
