...
--회원정보 관리 황소희 2019-02-08
drop table external_m_info;
create table external_m_info(
  memberNo number,
  email varchar2(100),
  interlinked_info varchar2(50),
  name varchar2(200)
);

drop table internal_m_info;
create table internal_m_info(
  memberNo number,
  email varchar2(100),
...
alter table internal_m_info add PRIMARY KEY (memberNo);
alter table external_m_info add PRIMARY KEY (memberNo);

--회원테스트 데이터
insert into INTERNAL_M_INFO values(memberNo_seq.nextval, 'soheemon@gmail.com', '1234', 'sohee');
insert into EXTERNAL_M_INFO values(memberNo_seq.nextval, 'soheemon@gmail.com', 'kakao', 'sohyun');
