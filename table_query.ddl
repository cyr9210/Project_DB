...
ALTER TABLE CHAT
	ADD (CONSTRAINT  R_31 FOREIGN KEY (INFO_NO) REFERENCES PRJ_INFO(INFO_NO)on DELETE CASCADE);

ALTER TABLE CHAT_HISTORY
	ADD (CONSTRAINT  R_26 FOREIGN KEY (CHAT_NO) REFERENCES CHAT(CHAT_NO)on DELETE CASCADE);
...
ALTER TABLE LABEL
	ADD (CONSTRAINT  R_11 FOREIGN KEY (P_NO) REFERENCES POST(P_NO)on DELETE CASCADE);
